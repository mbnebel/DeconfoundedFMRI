...
png("ReviewerResponse/Naive_zstat_groupdifference_fdr05_extensiveImpute.png",width=5,height=5,units="in",res=200)
...
png("ReviewerResponse/DRTMLE_zstat_groupdifference_fdr05_extensiveImpute.png",width=5,height=5,units="in",res=200)
...
knitr::kable(results.sigEdges, "latex", linesep = "", vline = "",
  ...
  kableExtra::as_image(width = 7, file = "ReviewerResponse/tableS3_extensiveImpute.pdf")
...
png("ReviewerResponse/Naive_zstat_groupdifference_fdr20_extensiveImpute.png",width=5,height=5,units="in",res=200)
...
png("ReviewerResponse/DRTMLE_zstat_groupdifference_fdr20_extensiveImpute.png",width=5,height=5,units="in",res=200)
