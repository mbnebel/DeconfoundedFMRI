...
png("./fig_meanFD_allGAM_TD_ASD_cc_none.png",width=10,height=5,units="in",res=200)
...
png("./fig_meanFD_allGAM_TD_ASD_cc_3levels.png",width=11,height=11,units="in",res=200)
cowplot::plot_grid(top_row, NULL, 
                   second_row, NULL, 
                   third_row, NULL, 
                   fourth_row, NULL, 
