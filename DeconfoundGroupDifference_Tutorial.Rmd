...
2. to show how DRTMLE adjusts our associational estimand for this confounding

Our parameter of interest is the average difference in functional connectivity between ASD and typically developing (TD) children. For the ASD group, our goal is to calculate the mean functional connectivity across the spectrum of autism severity.
